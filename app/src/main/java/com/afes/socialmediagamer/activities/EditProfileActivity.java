...
import com.afes.socialmediagamer.models.User;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    TextInputEditText mtextInputAboutMe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtextInputAboutMe = findViewById(R.id.textInputAboutMe);
        ...
        mUsersProvider.getUser(mAuthProvider.getUid()).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("aboutme")) {
                        mAboutMe = documentSnapshot.getString("aboutme");
                        mtextInputAboutMe.setText(mAboutMe);
                    }
    ...
    private void clickEditProfile() {
        ...
        mAboutMe = mtextInputAboutMe.getText().toString();
