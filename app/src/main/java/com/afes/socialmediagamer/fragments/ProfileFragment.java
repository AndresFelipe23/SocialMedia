...
import com.afes.socialmediagamer.activities.EditProfileActivity;
import com.afes.socialmediagamer.adapters.MyPostsAdapter;
...
public class ProfileFragment extends Fragment {
    ...
    View mView;
    CardView mLinearLayoutEditProfile;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTextViewAboutMe = mView.findViewById(R.id.textViewAboutMe);
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("aboutme")) {
                        ...
                        mTextViewAboutMe.setText(aboutme);
                    }
